      ...
      <div className="w-3/4 p-6 flex flex-col justify-between">
        ...
        <div className="flex-1 flex items-center justify-center">
          <video
            ...
            onClick={() => console.log(`/${currentChapter}-${chapters[currentChapter].replace(/\s+/g, "_")}`)}
          >
            <source
              src={`/${currentChapter}-${chapters[currentChapter].replace(/\s+/g, "_")}.mov`}
              type="video/mp4"
            />
        ...
        <div className="text-center mt-4 flex justify-center items-center gap-4">
          ...
          <span className="text-cyan-300">{`${currentChapter + 1} of ${chapters.length}`}</span>
          <span
            className={`cursor-pointer text-cyan-300 hover:text-cyan-500 transition duration-300 text-2xl ${
