    ...
    <div className="container mx-auto px-4 py-8">
      <Card color="cyan" className="relative min-h-[80vh]">
        ...
        <button
          ...
          className="absolute bottom-4 right-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg px-4 py-2 flex items-center space-x-2 hover:from-blue-600 hover:to-cyan-600 transition-all duration-300"
        >
