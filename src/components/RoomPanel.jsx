      ...
      <Card color="cyan" className="relative min-h-[80vh]">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            ...
            className={roomStarted ? "bg-gray-500 text-white rounded-lg px-4 py-2 flex items-center space-x-2" : "bg-gray-500 text-white rounded-lg px-4 py-2 flex items-center space-x-2"}
          >
