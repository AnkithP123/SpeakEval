...
function Room() {
  ...
  return (
    ...
    >
      <h1 className="text-4xl font-bold mb-4">Welcome to Room {roomCode.toString().slice(0, -3)}</h1>
      <p className="text-2xl mb-8">
        Hello, {name}! Please wait until your instructor starts this oral examination. Watch this informational video
        while you wait. Please note that the layout has been slightly changed from the time of recording, and a
        countdown timer has been added at the top. Remember to use the audio testing console at the bottom to make sure
        you can record and fetch audio from the server.
      </p>
      <div className="w-full max-w-xl py-8">
        <div className="aspect-w-16 aspect-h-9">
          <video className="rounded-3xl shadow-lg" width="640" height="360" controls>
      ...
      <div className="w-full max-w-4xl flex flex-col md:flex-row justify-center gap-8">
        <Card color="blue" className="w-full md:w-1/2">
          ...
          <div className="flex flex-col items-center">
            <div className="mb-4">
              <p className="text-lg mb-2">Click the button below to start or stop recording your audio:</p>
              <button
                onClick={recording ? stopRecording : startRecording}
                className={`px-6 py-3 rounded-full transition-colors duration-500 ${recording ? "bg-red-500 hover:bg-red-600" : "bg-blue-500 hover:bg-blue-600"} text-white font-bold`}
              >
            ...
            {audioURL && (
              <div className="mb-4">
                <p className="text-lg mb-2">Play back your recorded audio below, to make sure your mic works:</p>
                <p className="text-lg mb-4">
                  If you are unable to play or hear it, ask for help, and you may need to change some settings or switch
                  devices.
                </p>
        ...
        <Card color="purple" className="w-full md:w-1/2">
          ...
          <div className="flex flex-col items-center">
            <div className="mb-4">
              <p className="text-lg mb-2">Click the button below to fetch a test audio from the server:</p>
              <button
            ...
            {testAudioURL && (
              <div>
                <p className="text-lg mb-2">Play the test audio below, and make sure you can play it and hear it:</p>
                <p className="text-lg mb-4">
                  If you are unable to play or hear it, ask for help, and you may need to change some settings or switch
                  devices.
                </p>
      ...
      <div className="mt-12 max-w-4xl text-center">
        <p className="text-xl font-bold text-red-400">
          Important: Please make sure you can record and play back audio on your device. If you can't, please check your
          device settings and permissions, and try again. If you still can't, please contact your instructor. Do not let
          your instructor start the exam until you can record and play back audio successfully. You may need to switch
          devices.
        </p>
      </div>
    </div>
