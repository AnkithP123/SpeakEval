...
const Configure = () => {
    ...
    const handleRegisterConfig = async () => {
        try {
            ...
            const res = await fetch(`https://backend-p3sy.onrender.com/registerconfig?id=${id}&pin=${userId}&length=${questions.length}&rubric=${categoriesString}&limit=${maxTime}&language=${selectedLanguage}`, {
                method: 'POST',
                body: formData,
            });
