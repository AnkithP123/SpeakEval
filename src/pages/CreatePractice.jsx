  ...
  return (
    <div className="container">
      <Card className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-center">Create Practice Exam</h1>

        <div className="space-y-6">
          <div>
            <label className="block text-lg font-semibold mb-2">Select Configuration</label>
            <select value={selectedConfig} onChange={handleConfigChange} className="input">
          ...
          {selectedConfig && (
            <>
              <div>
                ...
                <input type="number" value={responseTime} readOnly className="input bg-gray-700" />
          ...
          <button onClick={handleCreatePractice} className="btn btn-primary w-full">
