                  ...
                  <Card color="cyan">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      >
                        <FaInfoCircle className="text-green-300 cursor-help" />
                        <div
                          className="absolute top-full mt-2 w-72 p-4 bg-slate-800 border border-slate-600 rounded-lg shadow-lg 
                   opacity-0 group-hover:opacity-100 transition-opacity duration-300 invisible group-hover:visible
                   transform -translate-x-1/2 left-1/2 pointer-events-none z-[500]"
                        >
                          {/* Arrow pointing up */}
                     ...
                     border-x-8 border-x-transparent
                     border-b-8 border-b-slate-800"
                          ></div>
                          <p className="text-slate-200 text-sm z-100">
